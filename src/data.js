import sealednectar1 from "./img/sealednectar1.jpg";
import brief from "./img/brief.gif";
import choice from "./img/choice.gif";
import healingbody from "./img/healingbody.gif";
...
export const data = [
  ...
  [
    ...
    5,
    "https://www.kalamullah.com/Books/islam-guide.pdf",
  ],
  [
    choice,
    "The Choice",
    ...
    8,
    "https://www.kalamullah.com/Books/choice1.pdf",
  ],
  [
    healingbody,
    "Healing Body & Soul",
